...
| `docs/` | Концепция, дорожная карта |

## Текущий этап

**Этап 0 — каркас репозитория и C4 Level 1.** Лендинг, DNS, GitHub Actions, БД и observability — следующие шаги (см. [docs/ROADMAP.md](docs/ROADMAP.md)).
