export const site = {
  ...
  contacts: {
    ...
    siteLabel: "genaisolution.ru",
    siteHref: "https://genaisolution.ru/ls",
...
export const credentials = {
  ...
  highlights: [
    "SAP C_TS4FI_1909 · SAP C_TS410_2020",
    "Лидеры России — 2017, 2019",
    "SQL, SAP S/4HANA, менеджмент проектов — Нетология, SAP SE, Т1",
  ],
} as const;
