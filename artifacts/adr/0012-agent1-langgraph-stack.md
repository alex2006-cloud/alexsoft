...
- **Решение:**
  ...
  - **LLM:** OpenAI-compatible клиент → `AI_GATEWAY_URL/v1`, ключ `LITELLM_MASTER_KEY`, модель `AGENT1_MODEL` (по умолчанию `qwen`). Прямых вызовов DashScope / OpenAI из агента нет.
